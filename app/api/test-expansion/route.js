...
export async function GET(req) {
  try {
    ...
    console.log(`📰 Fetching ${limit} articles from Expansión (category: ${category})`);

    const articles = await getExpansionArticles(limit * 2); // Get more to filter
