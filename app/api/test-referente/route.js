...
import { getReferenteArticles } from "@/libs/referente";

/**
 * Test endpoint for Referente.mx
 * GET /api/test-referente?limit=20
 */
export async function GET(req) {
  try {
    ...
    console.log(`📰 Fetching ${limit} articles from Referente.mx (category: ${category})`);

    const articles = await getReferenteArticles(limit * 2); // Get more to filter
