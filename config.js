...
const config = {
  ...
  domainName: "www.startupchihuahua.org", // Dominio para emails (debe estar verificado en Resend)
  ...
  // URL del logo para usar en emails. Debe ser una URL pública (Cloudinary, CDN, etc.)
  // Para obtener esta URL: sube Logo.png a Cloudinary y copia la URL segura (secure_url)
  logoUrl: process.env.NEXT_PUBLIC_LOGO_URL || "https://res.cloudinary.com/tu-cloud-name/image/upload/v1234567890/Logo.png",
  mailgun: {
    // subdomain to use when sending emails, if you don't have a subdomain, just remove it. Highly recommended to have one (i.e. mg.yourdomain.com or mail.yourdomain.com)
    subdomain: "",
    // REQUIRED — Email 'From' field to be used when sending magic login links
    fromNoReply: `neo <noreply@sandbox0b226c3b19e24eaca12f902bbab43bb1.mailgun.org>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `neo <admin@sandbox0b226c3b19e24eaca12f902bbab43bb1.mailgun.org>`,
    // Email shown to customer if need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "tu-email@gmail.com", // Cambia esto por tu email real
    // When someone replies to supportEmail sent by the app, forward it to the email below (otherwise it's lost). If you set supportEmail to empty, this will be ignored.
    forwardRepliesTo: "tu-email@gmail.com", // Cambia esto por tu email real
  },
  colors: {
